...
export const DEFAULT_CMS_POSTS: CMSContent[] = [
  {
    ...
    subtitle: "Solxa Supermarket & Grocery ERP",
  ...
  },
  {
    ...
    content_body: "Solxa Grocery ERP is an enterprise-grade retail platform engineered for high-volume inventory management, double-entry financial ledger accounting, and rapid barcode POS checkout.",
