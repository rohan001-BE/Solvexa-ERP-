    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        <div className="solvexa-card p-5 border-0 bg-gradient-to-br from-amber-600 via-orange-500 to-rose-600 shadow-xl shadow-amber-600/20 relative overflow-hidden group">
          ...
          <div className="relative z-10 flex items-start justify-between">
            <div className="space-y-1.5">
              <span className="text-[11px] font-black uppercase tracking-widest text-amber-100/80">Distributors</span>
              <p className="text-3xl font-black text-white font-mono tracking-tight">{suppliers.length}</p>
            </div>
          ...
          <div className="relative z-10 mt-4 flex items-center gap-2 text-[10px] font-bold text-amber-100/70 bg-black/20 w-max px-2.5 py-1 rounded-lg backdrop-blur-sm border border-white/5">
            ...
            <span>Wholesale supply partners</span>
          </div>
        </div>
        ...
        <div className="solvexa-card p-5 border-0 bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 shadow-xl shadow-purple-900/20 relative overflow-hidden group">
          ...
          <div className="relative z-10 flex items-start justify-between">
            <div className="space-y-1.5">
              <span className="text-[11px] font-black uppercase tracking-widest text-purple-200/80">Purchased Volume</span>
              <p className="text-3xl font-black text-white font-mono tracking-tight">
                Rs. {totalPurchasesVolume.toLocaleString(undefined, { minimumFractionDigits: 0 })}
              </p>
            </div>
            <div className="w-10 h-10 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 shadow-inner">
          ...
          <div className="relative z-10 mt-4 flex items-center gap-2 text-[10px] font-bold text-purple-200/70 bg-black/20 w-max px-2.5 py-1 rounded-lg backdrop-blur-sm border border-white/5">
            ...
            <span>Total inward wholesale</span>
          </div>
        </div>
        ...
        <div className="solvexa-card p-5 border-0 bg-gradient-to-br from-rose-600 via-red-500 to-orange-600 shadow-xl shadow-rose-600/20 relative overflow-hidden group">
          ...
          <div className="relative z-10 flex items-start justify-between">
            <div className="space-y-1.5">
              <span className="text-[11px] font-black uppercase tracking-widest text-rose-100/80">Accounts Payable</span>
              <p className="text-3xl font-black text-white font-mono tracking-tight">
                Rs. {totalPayables.toLocaleString(undefined, { minimumFractionDigits: 0 })}
              </p>
            </div>
            <div className="w-10 h-10 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 shadow-inner">
          ...
          <div className="relative z-10 mt-4 flex items-center gap-2 text-[10px] font-bold text-rose-100/70 bg-black/20 w-max px-2.5 py-1 rounded-lg backdrop-blur-sm border border-white/5">
            ...
            <span>Unsettled vendor balance</span>
          </div>
        </div>
      </div>
